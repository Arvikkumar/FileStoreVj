...
class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {},ᴍʏ ɴᴀᴍᴇ {},𝙃𝙤𝙬 𝙩𝙤 𝙐𝙨𝙚 𝘽𝙤𝙩 & 𝙞𝙩❜𝙨 𝘽𝙚𝙣𝙚𝙛𝙞𝙩𝙨 ??\n\n
...
# Ask Doubt on telegram @KingVJ01
    ...
    ABOUT_TXT = """<b>𝙍𝙚𝙢𝙚𝙢𝙗𝙚𝙧 𝙩𝙝𝙖𝙩 𝙮𝙤𝙪’𝙧𝙚 𝙜𝙤𝙞𝙣𝙜 𝙩𝙤 𝙙𝙞𝙚. 𝙄𝙩’𝙨 𝙖 𝙜𝙧𝙚𝙖𝙩 𝙬𝙖𝙮 𝙩𝙤 𝙧𝙚𝙢𝙚𝙢𝙗𝙚𝙧 𝙩𝙤 𝙡𝙞𝙫𝙚 ✨

🤖 ᴍʏ ɴᴀᴍᴇ: {}"""

    CABOUT_TXT = """<b>𝙍𝙚𝙢𝙚𝙢𝙗𝙚𝙧 𝙩𝙝𝙖𝙩 𝙮𝙤𝙪’𝙧𝙚 𝙜𝙤𝙞𝙣𝙜 𝙩𝙤 𝙙𝙞𝙚. 𝙄𝙩’𝙨 𝙖 𝙜𝙧𝙚𝙖𝙩 𝙬𝙖𝙮 𝙩𝙤 𝙧𝙚𝙢𝙚𝙢𝙗𝙚𝙧 𝙩𝙤 𝙡𝙞𝙫𝙚 ✨
