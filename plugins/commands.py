...
# Ask Doubt on telegram @KingVJ01
        ...
        await message.reply_text(f"<b><u> This Movie File/Video will be deleted in <b><u>{AUTO_DELETE} mins</u> 🫥 <i></b> Due to Copyright Issues </i></b>")
        ...
        async for msg in client.iter_messages(int(f_chat_id), int(l_msg_id), int(f_msg_id)):
            if msg.media:
                ...
                try:
                    h = await message.reply_text(f"<b><u> This Movie File/Video will be deleted in <b><u>{AUTO_DELETE} minutes</u> 🫥 <i></b>(Due to Copyright Issues)</i></b>")
